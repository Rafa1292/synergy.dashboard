...
const Filter = () => {
    const [openFilterClass, setOpenFilterClass] = useState('filter-expanse_opened');
    ...
    return (
        <>
            <div className="col-xl-6 justify-content-center mt-3 d-flex py-4 flex-wrap">
                <h2 className='col-8 justify-start bold'>
                    <strong>
                        Preferencias
                    </strong>
                </h2>
                <div className="col-8 justify-start d-flex">
                    <select defaultValue={1} className="fs-5 text-muted form-select form-select-lg" aria-label=".form-select-sm">
                ...
                <div className=" d-flex col-2 py-2 justify-content-end">
                    <div onClick={() => OpenFilter()} style={openFilterClass === '' ? {} : filterBtn} className="filter-settings_btn ">
                        <img height={25} src={settingsImg} />
                    </div>
                </div>
                <div className={`filter-expanse justify-content-center d-flex flex-wrap col-xl-6 ${openFilterClass}`}>

                    <div className="col-8 flex-wrap d-flex p-1">
                    ...
                    <div className="col-8 flex-wrap d-flex p-1">
                        ...
                        <input placeholder='Cualquiera'
                            className='form-control py-3 my-1 fs-5' />
                    </div>
                    <div className="col-8 flex-wrap d-flex p-1">
